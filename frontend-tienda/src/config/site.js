// Datos del negocio: edita aquí los enlaces y la información de contacto.
...
export const SITE_INFO = {
  nombre: "Tiendas Lauren",
  descripcion:
    "Encuentra maquillaje, carteras, mochilas y mucho más. Cotiza al instante por WhatsApp.",
};
